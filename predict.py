...
img_path = "pcb_dataset/m_nut/m_nut8.jpg"
...
multipleImagesUsingCSV = 1
CSV_path = "bom.csv"
pcbImageForCSVprediction_path = "imgs/pcb_detection_4.png"
    ...
    if multipleImagesUsingCSV:
        ...
        for i, row in csvFile.iterrows():
            ...
            if classes.item() > 2 and classes.item() < 8:
                cv2.rectangle(showPcbImage, (point1_x, point1_y), (point2_x, point2_y), red, 2)
            else:
                cv2.rectangle(showPcbImage, (point1_x, point1_y), (point2_x, point2_y), green, 2)
            cv2.putText(showPcbImage, str(labels_map[classes.item()]), (point1_x,point2_y+20), cv2.FONT_HERSHEY_DUPLEX, 0.5, [0,255,255], 1)
